...
type TeamMember = {
    ...
    name: string;
    role: string;
    image: string; // The imported variable (e.g., Team21)
    socials: {
        facebook: string;
        twitter: string;
        pinterest: string;
                                    ...
                                    <div className="team-two__img-box">
                                        <div className="team-two__img">
                                            ...
                                            <div className="team-two__social">
                                                <Link to="/team-details"><i className="fab fa-facebook-f"></i></Link>
                                                <Link to="/team-details"><i className="fab fa-twitter"></i></Link>
                                                <Link to="/team-details"><i className="fab fa-pinterest-p"></i></Link>
                                                <Link to="/team-details"><i className="fab fa-instagram"></i></Link>
                                            </div>
                                        </div>
                                    </div>
