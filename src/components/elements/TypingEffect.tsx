...
const TypingEffect: React.FC<TypingEffectProps> = ({
    ...
    }, [currentCharIndex, currentStringIndex, isDeleting, strings, typeSpeed, deleteSpeed, pauseDuration, setTypedText, setCurrentStringIndex, setIsDeleting, setCurrentCharIndex]);
