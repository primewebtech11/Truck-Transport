    ...
    return (
        <section className="why-choose-two">
            ...
            <FadeInAdvanced className='why-choose-two__img'>
                <img src={WhyChooseTwoImg1} />
            </FadeInAdvanced> 
            <div className="why-choose-two__client-box">
                <ul className="why-choose-two__review-list">
                    <li>
                        <div className="why-choose-two__review-img">
                            <img src={WhyChooseTwoReviewImg11} />
                        </div>
                    </li>
                    <li>
                        <div className="why-choose-two__review-img">
                            <img src={WhyChooseTwoReviewImg12} />
                        </div>
                    </li>
                    <li>
                        <div className="why-choose-two__review-img">
                            <img src={WhyChooseTwoReviewImg13} />
                        </div>
                    </li>
                    <li>
                        <div className="why-choose-two__review-img">
                            <img src={WhyChooseTwoReviewImg14} />
                        </div>
                    </li>
                </ul>
                    ...
                    <div className="col-xl-8">
                        <div className="why-choose-two__left">
                            <div className="why-choose-two__title-box">
                                ...
                                <p className="why-choose-two__text">A logistic service provider company plays a pivotal role
                                    in
                                    the
                                    global supply chain ecosystem by efficiently managing the movement of goods from
                                    point
                            ...
                            <div className="why-choose-two__point-box">
                                <ul className="why-choose-two__point">
                                    <li>
                                        ...
                                        <div className="why-choose-two__content">
                                            <h4>Global Logistics <br /> Operation</h4>
                                            <p>A logistic service provider company plays a role in the global chain</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="why-choose-two__icon">
                                ...
                                <ul className="why-choose-two__point why-choose-two__point--two">
                                    <li>
                                        ...
                                        <div className="why-choose-two__content">
                                            <h4>Safety & Security <br /> Delivery</h4>
                                            <p>A logistic service provider company plays a role in the global chain</p>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div className="why-choose-two__content">
                                            <h4>Real Time location <br /> Tracking</h4>
                                            <p>A logistic service provider company plays a role in the global chain</p>
                                        </div>
                                    </li>
                                </ul>
