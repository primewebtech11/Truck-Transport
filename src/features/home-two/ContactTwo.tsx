...
import ContactOneShapeBg from '../../assets/images/shapes/contact-one-shape-bg.png';
import ContactOneBgImg from '../../assets/images/backgrounds/contact-one-bg-img.jpg';
