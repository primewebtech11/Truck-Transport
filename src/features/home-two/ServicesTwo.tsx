...
export default function ServicesTwo() {
    return (
        <SectionWrapper className="services-two" id='services'>
                                    ...
                                    <div className="services-two__content">
                                        ...
                                        <ul className="services-two__point">
                                            <li>
                                                ...
                                                <div className="text"><p>Quality Control System</p></div>
                                            </li>
                                            <li>
                                                <div className="icon"><span className="fas fa-check"></span></div>
                                                <div className="text"><p>Real-Time Tracking</p></div>
                                            </li>
                                            <li>
                                                <div className="icon"><span className="fas fa-check"></span></div>
                                                <div className="text"><p>100% True Result Provide</p></div>
                                            </li>
                                        </ul>
