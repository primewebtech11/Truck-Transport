...
const TrackTransportForm: React.FC = () => { 
    return (
        <div className="quote-tab-content-box-item">
            <div className="tab-content-box-item-img bg_2" >
            </div>
                                    ...
                                    <div className="quote-redio-box">
                                        <div className="quote-redio">
                                            <label className="custom-rario">
                                                <input type="radio" name="myRadios" value="1" readOnly />
                                                <span className="radio-dot"></span>
                                                <span className="radio-text">Express Delivery</span>
                                            </label>
                                            <label className="custom-rario">
                                                <input type="radio" name="myRadios" value="2" defaultChecked readOnly />
                                                <span className="radio-dot"></span>
...
export default TrackTransportForm;