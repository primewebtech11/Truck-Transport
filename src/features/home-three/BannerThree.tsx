                        ...
                        <div className="banner-two__left">
                            ...
                            <div className="banner-two__tab-box tabs-box">
                                <ul className="tab-buttons clearfix list-unstyled">
                                    <li className={`tab-btn ${transportType === "air" ? "active-btn" : ""}`} onClick={() => setTransportType("air")}>
                                        <p>Air Freight</p>
                                    </li>
                                    <li className={`tab-btn ${transportType === "road" ? "active-btn" : ""}`} onClick={() => setTransportType("road")}>
                                        <p>Road Freight</p>
                                    </li>
                                    <li className={`tab-btn ${transportType === "ocean" ? "active-btn" : ""}`} onClick={() => setTransportType("ocean")}>
                                        <p>Ocean Freight</p>
                                    </li>
                                </ul>
