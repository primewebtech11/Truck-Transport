                                ...
                                <div className="section-title text-left sec-title-animation animation-style1">
                                    ...
                                    <h3 className="section-title__title">
                                        <TextAnimation animationStyle="style1">
                                            ...
                                            We Are <span>Often Considered</span>
                                        </TextAnimation>
                                    </h3>
                                </div>
                                <p className="skill-one__text">A logistic service provider company plays a pivotal role in the
                                    global supply chain ecosystem by efficiently managing the movement of goods from point
                                ...
                                <div className="skill-one__progress-box">
                                    {
                                        barItem.map((bar: BarItem) => (
                                            <Progresbar key={bar.id} title={bar.title} value={bar.value} />
                                        ))
                                    }
                                </div>
                                <div className="skill-one__btn-box">
                                    <Link to="/contact" className="thm-btn">Book Your Parcel
